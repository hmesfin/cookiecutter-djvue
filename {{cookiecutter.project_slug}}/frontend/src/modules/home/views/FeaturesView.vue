...
const coreFeatures = ref({% if cookiecutter.use_typescript == 'y' %}<Feature[]>{% endif %}[
  {
    id: 'authentication',
...
const comparisons = ref({% if cookiecutter.use_typescript == 'y' %}<Comparison[]>{% endif %}[
  {
    feature: 'Setup Time',
  ...
  },
  {
    ...
    ours: 'Latest versions',
    others: 'Often outdated',
    othersHas: true
  },
  {
